...
public class AudioSpatializer : MonoBehaviour
{
    ...
    private void OnEnable() => CallbackScheduler.RegisterCallback(OnLateUpdate, CallbackType.LateUpdate);
    private void OnDisable() => CallbackScheduler.RegisterCallback(OnLateUpdate, CallbackType.LateUpdate);
