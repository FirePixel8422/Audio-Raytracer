...
//    [BurstCompile]
//    private bool RayIntersectsAABB(float3 rayOrigin, float3 rayDir, float3 center, float3 halfExtents, out half distance)
//    {
...
//        distance = (half)(tNear > 0 ? tNear : tFar);
//        return true;
//    }


//    [BurstCompile]
//    private bool RayIntersectsOBB(float3 rayOrigin, float3 rayDir, float3 center, float3 halfExtents, quaternion rotation, out half distance)
//    {
...
//    [BurstCompile]
//    private bool RayIntersectsSphere(float3 rayOrigin, float3 rayDir, float3 center, float radius, out half distance)
//    {
...
//            if (RayIntersectsAABB(rayOrigin, rayDir, collider.center, collider.size, out half dist) && dist < distToOriginalOrigin)
//            {
//                return false;
//            }
//        }
...
//            if (RayIntersectsOBB(rayOrigin, rayDir, collider.center, collider.size, collider.Rotation, out half dist) && dist < distToOriginalOrigin)
//            {
//                return false;
//            }
//        }
...
//            if (RayIntersectsSphere(rayOrigin, rayDir, collider.center, collider.radius, out half dist) && dist < distToOriginalOrigin)
//            {
//                return false;
//            }
//        }
